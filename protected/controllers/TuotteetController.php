...
class TuotteetController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Tuotteet'];
	...
	{
		$dataProvider=new CActiveDataProvider('Tuotteet');
	...
	{
		$model=new Tuotteet('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tuotteet']))
			$model->attributes=$_GET['Tuotteet'];
	 ...
	 * @param Tuotteet $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tuotteet-form')
		{
